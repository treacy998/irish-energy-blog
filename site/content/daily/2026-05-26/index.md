...
*Updated 2026-08-27: the BESS simulation previously allowed the discharge window to occur before the charge window ended, which is physically impossible for a battery — in this case, by picking the 07:00–08:30 morning peak, which falls before the midday charge. Recalculated enforcing charge-before-discharge; gross profit corrected from €94 to €66.*

€66 gross. The day's highest-priced block was actually the morning (07:00–08:30, averaging €198.45), beating the evening peak's best block (18:30–20:00, €184.91) by €13/MWh — but the charge sits in the midday belly (13:00–14:30, €121 avg), *after* the morning peak has already happened. A same-day cycle can only reach the evening, so today discharges into the lower of the two peaks: €182 average at 18:30.

## Commentary

A working Tuesday inside the wind drought. Mean €151.18 (level with yesterday), and the structural feature is a morning peak that outpriced the evening: wind 2–3% through the morning ramp produced €212 at 07:30, while wind 5–9% through the evening capped the second peak at €184. For a battery, though, the morning peak isn't reachable — it happens before the midday charge — so the market's own highest price and the battery's actual payday are two different windows today.
...
For storage, €66 gross — a modest mid-range day made smaller by causality. The market's real peak was the morning (€212 at 07:30), but it fell before the midday charge, so the battery could only reach the lower evening peak (€182 at 18:30). The gap between "the day's best price" and "the best price a same-day cycle can actually capture" is the operational lesson: a real asset with an overnight-charge option would have priced this very differently.
